...
//DocumentReference availabilityRef;
    ...
    public void isLoading(Boolean isLoading){
        progressBar = findViewById(R.id.searchChatProgressBar);
        if(isLoading){
...
//        super.onPause();
//        availabilityRef.update(Constants.KEY_AVAILABILITY, 0);
//    }
//
//    @Override
//    protected void onResume() {
//        super.onResume();
//        availabilityRef.update(Constants.KEY_AVAILABILITY, 1);
//    }
}